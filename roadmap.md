...
- **Этап:** Этап 0 - Подготовка (ЗАВЕРШЁН ✅)
- **Прогресс:** 9/40+ задач выполнено (22%)
- **Следующее:** Этап 1 - Изучение официальной документации и анализ тестового файла
...
Изучение:
- [ ] Изучить официальную документацию (React, ECharts, TypeScript) (2-3 часа)
  - React 18: https://react.dev/
  - ECharts: https://echarts.apache.org/
  - TypeScript: https://www.typescriptlang.org/docs/

Анализ тестового файла:
- [ ] Открыть test-data/Vesta 1.6 IM.det в редакторе (10 мин)
- [ ] Изучить структуру построчно (30 мин)
  - Строка 1: метаданные
  - Строка 2: названия колонок
  - Строка 3+: маркеры и данные
- [ ] Написать скрипт анализа файла (1-2 часа)
  - Вывести все уникальные маркеры расчётов
  - Вывести список всех колонок
  - Вывести количество точек данных на расчёт
  - **⚠️ УЧЕСТЬ: первая колонка служебная!**

Типы TypeScript:
- [ ] Создать типы на основе РЕАЛЬНЫХ данных (1 час)
  - `EngineMetadata` (цилиндры, тип)
  - `DataPoint` (RPM, P-Av, Torque, ...)
...
- [ ] Установить зависимости (express, cors, js-yaml, chokidar) (15 мин)
- [ ] Настроить Express сервер (src/server.js) (1 час)
  - CORS middleware
  - JSON parsing
  - Error handling
...
Конфигурация:
- [ ] Создать модуль загрузки config.yaml (src/config.js) (1 час)
- [ ] Тестировать загрузку конфигурации (30 мин)
...
**Следующее:**
- **Этап 1:** Изучить официальную документацию (React, ECharts, TypeScript)
...
3. Выполни задачу (1-3 часа)
4. Отметь [X] в roadmap
5. Обнови "📝 Текущая сессия"
6. Повторяй
...
**Общий прогресс: 9/40+ задач (22%) - Этап 0 завершён! Готов к кодированию 🚀**
