...
- ✅ Правильно: Написать в `ENGINE-VIEWER-V2-SPEC.md` (ТЗ), остальные ссылаются на спеку
...
│
├── ENGINE-VIEWER-V2-SPEC.md ──────► ТЕХНИЧЕСКОЕ ЗАДАНИЕ (ИСТОЧНИК ИСТИНЫ)
...
- [ ] Обнови ENGINE-VIEWER-V2-SPEC.md
...
- Пример: формат .det файлов живет в `ENGINE-VIEWER-V2-SPEC.md`
...
❌ **НЕ изменяй ENGINE-VIEWER-V2-SPEC.md без согласования:**
...
- **Требования проекта?** → ENGINE-VIEWER-V2-SPEC.md (НЕ ИЗМЕНЯТЬ!)
- **Детальная установка?** → docs/setup.md
...
**ENGINE-VIEWER-V2-SPEC.md (источник истины):**
```markdown
## Формат .det файлов
...
См. [формат данных](ENGINE-VIEWER-V2-SPEC.md#формат-det-файлов).
```
...
- **ENGINE-VIEWER-V2-SPEC.md** - НЕ ИЗМЕНЯТЬ (источник требований)
