...
### Есть ли подписка или платные функции?

**Нет.** Engine Viewer — это полностью бесплатное приложение с открытым исходным кодом (лицензия MIT). 

- ✅ Все функции доступны бесплатно
- ✅ Нет подписок, регистраций или платежей
- ✅ Нет ограничений на использование
- ✅ Можно использовать в коммерческих проектах

**Где изменить подписку?** Подписок в приложении нет — всё бесплатно! Если вы видите упоминания о Premium-функциях в документации, это планы на будущее, которые пока не реализованы.

### Как поддержать проект?

- ⭐ Поставьте звезду на [GitHub](https://github.com/engsimsoft/engine-viewer)
- 🐛 Сообщайте о багах через [Issues](https://github.com/engsimsoft/engine-viewer/issues)
